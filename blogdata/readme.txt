...
= Version 1.8.5
* Remove Unnecessary Code And Space.

= Version 1.8.6
* Fixed empty author description paragraph output.

= Version 1.8.7
* Added Site Title and Tagline visibility options.

= Version 1.8.8
* Fixed Tab Keyword Focus Issue.

= Version 1.8.9
* Enhanced CSS structure and performance.
...
= Version 1.9.4
* Inhanced the Customizer settings.

= Version 1.9.5
* Inhanced the Customizer setting for header option.