...
if ( ! function_exists( 'blogdata_header_site_title_tagline' ) ) :
    function blogdata_header_site_title_tagline() {
...
add_action('blogdata_action_header_site_title_tagline','blogdata_header_site_title_tagline');

if ( ! function_exists( 'blogdata_footer_site_title_tagline' ) ) :
    function blogdata_footer_site_title_tagline() {
        $title   = display_header_text();
        $tagline = get_theme_mod( 'display_header_tagline', false );
...
add_action('blogdata_action_footer_site_title_tagline','blogdata_footer_site_title_tagline');
