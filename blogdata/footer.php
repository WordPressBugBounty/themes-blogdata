                                ...
                                <div class="<?php echo esc_attr( has_nav_menu( 'footer') ? 'col-lg-6 col-md-6 text-xs' : 'col-lg-12 text-center'); ?>">
                                    <?php if($hide_copyright == true) { ?>
                                        <p class="mb-0">
                                            ...
                                            <span class="sep"> | </span>
                                            <?php
                                            $themeName = !empty(BLOGDATA_THEMEURI) ? '<a href="' . esc_url( BLOGDATA_THEMEURI ) . '" target="_blank">' . esc_html( BLOGDATA_THEME_NAME ) . '</a>': esc_html( BLOGDATA_THEME_NAME );
                                            printf(esc_html__('%1$s by %2$s.', 'blogdata'), $themeName, '<a href="https://themeansar.com" target="_blank">Themeansar</a>'); ?>
                                            </a>
                                        </p>
                                    <?php } ?>                                       
                                </div>
